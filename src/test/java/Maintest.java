...
@Order(3)
    public void UrunTikla() throws InterruptedException {
       ...
       Adres.click();
       Adres.sendKeys("istanbull erahmet eokfakeeefefeegeggf");
       Adres.sendKeys(Keys.TAB);
       System.out.println("Adres Başarılı");
       driver.findElement(By.xpath("//*[@id=\"js-orders-modal-container\"]/div/div[2]/form/div[8]/div/div/label/input")).sendKeys("36037");
       System.out.println("Posta Kodu Başarılı");
